...
As an alternative to using `PUBLIC_ROLE_LIKE`, you can configure the **Public** role with specific permissions manually. This approach gives you more fine-grained control over what anonymous users can access.
